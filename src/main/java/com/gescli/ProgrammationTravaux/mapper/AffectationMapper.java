...
public interface AffectationMapper {
    ...
    @Mapping(target = "agentCode", source = "agent.code")
    @Mapping(target = "structureId", source = "agent.structure.id")
    @Mapping(target = "structureLibelle", source = "agent.structure.libelle")
